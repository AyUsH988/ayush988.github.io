...
/* harmony import */ var _piechart_piechart_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./piechart/piechart.component */ "./src/app/piechart/piechart.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _piechart_piechart_component__WEBPACK_IMPORTED_MODULE_11__["PiechartComponent"]
            ],
            imports: [
...
var CustomHttpService = /** @class */ (function () {
    function CustomHttpService(http) {
        ...
        this.helpLineUrl = _app_status_component_api_config__WEBPACK_IMPORTED_MODULE_2__["helpLineUrl"];
    }
    ...
    CustomHttpService.prototype.getHelpLine = function () {
...
/*!************************************************!*\
  !*** ./src/app/status-component/api-config.ts ***!
  \************************************************/
/*! exports provided: CovidUrl, countries, getStatusByCountry, stateUrl, cityUrl, helpLineUrl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "helpLineUrl", function() { return helpLineUrl; });
...
var helpLineUrl = 'https://covid-19india-api.herokuapp.com/helpline_numbers';
...
var StatusComponentComponent = /** @class */ (function () {
    function StatusComponentComponent(httpService) {
        ...
        this.helpLineList = [];
        this.stateHelpLine = '';
        this.chartLabel = ['Death', 'Total Cases', 'Recovered'];
        this.countryTotalChartData = [];
        this.countryLatestChartData = [];
        this.stateTotalChartData = [];
        this.cityChartLabel = ['Death', 'Total Cases', 'Recovered', 'Active'];
    ...
    StatusComponentComponent.prototype.getHelpLine = function () {
        for (var i = 0; i < this.helpLineList.length; i++) {
